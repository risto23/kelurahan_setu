                  ...
                  <table id="table_news" class="table table-bordered table-striped" width="100%">
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php echo fungsi_tgl($row['tanggal']); ?></td>
                        <td><?php echo $row['deskripsi']; ?></td>
                        <td><img src="../gambar_pengaduan/<?php echo $row['bukti']; ?>" width="100px"></td>
                        <td>
                          <?php
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              <li>
                                <a href="konfirmasi.php?id_konfirmasi=<?php echo $row['id_pengaduan']; ?>">Konfirmasi</a>
                              </li>
                              <li>

                                <a href="hapus.php?id_hapus=<?php echo $row['id_pengaduan']; ?>" onclick="javascript: return confirm('Anda yakin ingin menghapus data ?')"> Hapus</a>
                              </li>
                            </ul>
                            </div>
                          </td>
